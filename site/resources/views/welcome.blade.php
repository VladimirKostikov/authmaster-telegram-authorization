...
<body>
          ...
          <ul id="collapseMenu" class='lg:!flex lg:space-x-5 max-lg:space-y-2 max-lg:hidden max-lg:py-4 max-lg:w-full'>
            <li class='max-lg:border-b max-lg:bg-[#007bff] max-lg:py-2 px-3 max-lg:rounded'>
              <a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] block font-semibold text-[18px]' id="main_link">Main</a>
            </li>
            <li class='max-lg:border-b max-lg:py-2 px-3 max-lg:rounded'><a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] block font-semibold text-[18px]' id="about_link">About</a>
            </li>
            <li class='max-lg:border-b max-lg:py-2 px-3 max-lg:rounded'><a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] block font-semibold text-[18px]' id="usage_link">Usage</a>
            </li>
            <li class='max-lg:border-b max-lg:py-2 px-3 max-lg:rounded'><a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] font-semibold text-[18px]' id="advantages_link">Advantages</a>
            </li>
            <li class='max-lg:border-b max-lg:py-2 px-3 max-lg:rounded'><a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] font-semibold text-[18px]' id="media_link">Media</a>
            </li>
            <li class='max-lg:border-b max-lg:py-2 px-3 max-lg:rounded'><a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] block font-semibold text-[18px]' id="faq_link">FAQ</a>
            </li>
            <li class='max-lg:border-b max-lg:py-2 px-3 max-lg:rounded'><a href='javascript:void(0)'
                class='lg:hover:text-[#007bff] block font-semibold text-[18px]' id="socials_link">Socials</a>
            </li>
          </ul>
        </div>
    </header>
        ...
        <div class="lg:w-3/5 sm:w-1/2 m-auto">
            <div class="">
                <div class="text-white">
                    ...
                    <a href="{{ route('dashboard') }}" class="w-full text-[18px] font-bold p-10 bg-green-400 hover:bg-green-500 text-white w-full text-center p-3 rounded mt-10 block">Connect your webapp</a>
                    <p class="mt-5 mb-5">Made by <a href="https://github.com/VladimirKostikov/" class="underline font-bold underline-offset-8 hover:text-gray-100">Vladimir Kostikov</a></p>
    ...
    <section class="mt-[50px]" id="about">
    ...
    <section class="mt-[50px]" id="usage">
    ...
    <section class="mt-[50px]" id="advantages">
        <div class="w-3/5 m-auto text-[24px]">
    ...
    <section class="mt-[50px]" id="media">
        <div class="w-3/5 m-auto text-[24px]">
    ...
    <section class="mt-[50px] mb-[50px]" id="socials">
        <div class="w-3/5 m-auto text-[24px]">
            <h1 class="text-[36px] mb-5 leading-10 font-bold">Socials</h1>

            <p class="mt-10 mb-10 text-[24px]">
                Social networks where you can find information about the project
            </p>

            <p class="mt-10 mb-10 text-[24px]">
                Telegram group: <a href="https://t.me/authmaster" target="_blank" class="text-tg-100">https://t.me/authmaster</a>
            </p>

            <p class="mt-10 mb-10 text-[24px]">
                GitHub: <a href="https://github.com/VladimirKostikov/authmaster-telegram-authorization" target="_blank" class="text-tg-100">https://github.com/VladimirKostikov/authmaster-telegram-authorization</a>
            </p>
        </div>
    </section>
    ...
    $(window).on("scroll", function() {
        if ($(this).scrollTop() > 100) {
            ...
            $("header").addClass("border-b border-gray-200")
        }
        else {
            $("header").css("background","none");
            $("header").removeClass("text-black");
            $("header").removeClass("border-b border-gray-200")
        }
    });
    </script>
