                ...
                <div class="grid grid-cols-2">
                    <div>
                        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            <div class="flex flex-col pt-3">
                                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Переадресация</dt>
                    ...
                    <div class="bg-cyan-500 p-10 rounded">
                        ...
                        <div class="rounded bg-white hover:text-gray-400 p-2 mt-5 mb-5 truncate pr-8 relative cursor-pointer" onclick="copy('{{ $code }}', 'Код авторизации скопирован в буфер обмена')">
